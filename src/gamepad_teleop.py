...
class Gamepad_teleop(Thread, traitlets.HasTraits):
    ...
    @traitlets.validate('y')
    def monitor_throttle(self, proposal):
        #print('y : ', -proposal['value'])
        return  -proposal['value']
    
    @traitlets.validate('z')
    def monitor_steering(self, proposal):
        #print('z : ', proposal['value'])
        return  proposal['value']

    @traitlets.observe('btn_x')
    def monitor_btnx(self, change):
        self.x = -change['new']
        #print('bx : ', self.x)

    @traitlets.observe('btn_b')
    def monitor_btnb(self, change):
        self.x = change['new']
        #print('bb : ', self.x)
